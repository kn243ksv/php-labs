 ...
 *
 * Варіант 11: пароль довжини 13 з мінімум 1 великою, 1 малою літерою,
 * 1 цифрою та 1 спецсимволом
 */
...
// Обробка (варіант 11)
$action = $_POST['action'] ?? '';
$genLength = (int)($_POST['gen_length'] ?? 13);
$login = $_POST['login'] ?? 'student';
...
<div class="demo-card demo-card-wide">
    ...
    <p class="demo-subtitle">Генерує пароль довжини 13 із великою, малою літерою, цифрою та спецсимволом</p>
