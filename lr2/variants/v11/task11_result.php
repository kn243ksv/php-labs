 ...
 *
 * Варіант 11: X = 5, Y = 2
 * sin(5)=-0.9589, cos(5)=0.2837, tg(5)=-3.3805, my_tg(5)=-3.3805, 5^2=25, 5!=120
 */
...
function formatResult(string|int|float $value): string
{
    if (is_string($value)) {
        return $value;
    }
            ...
            <tr>
                ...
                <td>
                    ...
                    if (is_string($row['value'])) {
                        ...
                        echo htmlspecialchars(formatResult($row['value']));
                    }
                    ?>
                </td>
            </tr>
...
my_sin($x)      = <?= is_string($results[0]['value']) ? $results[0]['value'] : formatResult($results[0]['value']) . "\n" ?>
my_cos($x)      = <?= is_string($results[1]['value']) ? $results[1]['value'] : formatResult($results[1]['value']) . "\n" ?>
