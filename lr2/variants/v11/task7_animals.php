 ...
 *
 * Варіант 11: склади "бар ку ло мі зу тар но пі ша рі", 3 імені, 3 складів
 */
...
<div class="demo-card">
    ...
    <form method="post" class="demo-form">
        <div>
            ...
            <input type="text" id="syllables" name="syllables" value="<?= htmlspecialchars($syllablesInput) ?>" placeholder="бар ку ло мі зу тар но пі ша рі">
        </div>
        <div class="form-row">
            <div>
