...
- `http://localhost:8000/lr5/demo/` — ЛР5: Файли та БД (PDO)
...
- `http://localhost:8000/lr4/variants/v30/` — ЛР4 (MVC-додаток)
- `http://localhost:8000/lr5/variants/v30/` — ЛР5 (Кулінарний блог — файли + PDO)
...
5. ЛР1: скопіюй v30/ → vN/             (див. v30/README.md)
   ЛР2-5: створи файли в lrN/          (за прикладом з demo/)
...
- **ЛР1-3:** файли створюйте в `lrN/variants/vN/` (скопіюйте v30/ як шаблон). **ЛР4, ЛР5:** створіть MVC-структуру в `lrN/variants/vN/` (скопіюйте v30/ як шаблон)
...
│   └── assignment.md
├── lr3/
│   ├── demo/        # Робочий приклад (OOP)
│   ├── variants/
│   │   ├── v1.md ... v30.md
│   │   └── v30/     # Повністю розв'язаний варіант 30
│   └── assignment.md
├── lr4/
│   ├── demo/        # Робочий приклад (MVC)
│   ├── variants/
│   │   ├── v1.md ... v30.md
│   │   └── v30/     # Повністю розв'язаний варіант 30 (MVC)
│   └── assignment.md
├── lr5/
│   ├── demo/        # Робочий приклад (файли + PDO)
│   ├── variants/
│   │   ├── v1.md ... v30.md
